...
from digitization.detectboard import debug, image_object
from digitization.detectboard import poly_point_isect

__LAPS_SESS = onnxruntime.InferenceSession(
    "digitization/detectboard/models/laps_model.onnx")
